...
public class Board {
    ...
    private static final GUI_Field field4 = new GUI_Street("HVIDOVREVEJ", "kr. 1.200", "Buy this field kr. 1.200", "Rent kr. 50", new Color(255, 220, 38), Color.WHITE);
    ...
    private static final GUI_Field field21 = new GUI_Tax("PARKING", "Free Parking", "Parking_DESCRIPTION", new Color(8, 75, 8), Color.WHITE);
