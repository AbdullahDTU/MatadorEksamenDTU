...
public class Board {
    ...
    private static final GUI_Field field6 = new GUI_Street("Scandlines", "kr. 4.000", "Buy this field", "Rent kr.500", new Color(11, 47, 140), Color.BLACK);
    ...
    private static final GUI_Field field11 = new GUI_Jail(" ", "Jail", "Just Visiting", "JAIL_DESCRIPTION", new Color(0, 0, 0), Color.WHITE);
    ...
    private static final GUI_Field field13 = new GUI_Street("Squash", "kr.3.000", "Buy this field", "(Rent == Die Value)", new Color(255, 0, 0), Color.BLACK);
    ...
    private static final GUI_Field field16 = new GUI_Street("Mols-linjen", "kr 4.000", "Buy this field", "Rent kr. 500", new Color(255, 0, 0), Color.BLUE);
    ...
    private static final GUI_Field field21 = new GUI_Tax("Parking", "Free Parking", "Parking_DESCRIPTION", new Color(0, 197, 255), Color.BLACK);
    ...
    private static final GUI_Field field26 = new GUI_Street("Scandlines", "Kr. 4.000", "Buy this field", "Rent kr 500.", new Color(11, 47, 140), Color.BLACK);
    ...
    private static final GUI_Field field29 = new GUI_Street("Cocacola", "Kr. 3.000", "Buy this field", "Rent = DICE VALUE", new Color(255, 0, 0), Color.BLACK);
    ...
    private static final GUI_Field field31 = new GUI_Jail(" ", "Jail", "Go to Jail!", "JAIL_DESCRIPTION", new Color(0, 0, 0), Color.WHITE);
    ...
    private static final GUI_Field field36 = new GUI_Street("Scandlines", "Kr. 4.000", "Buy this field", "Rent kr 500.", new Color(11, 47, 140), Color.BLACK);
